          ...
          <div className="flex flex-wrap gap-4">
            {exhibit.liveUrl && (
              <a
                ...
                className="px-6 py-3 bg-[#00F0FF] text-[#050505] font-medium hover:bg-[#00FF88] transition-colors"
              >
                LIVE DEMO →
              </a>
            )}
            ...
            {exhibit.shaderKey && (
              <button
                ...
                className="px-6 py-3 border border-[#FF00FF] text-[#FF00FF] hover:bg-[#FF00FF] hover:text-[#050505] transition-colors"
              >
                VIEW SHADER CODE
              </button>
            )}
