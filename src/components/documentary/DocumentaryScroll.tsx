...
export const DOCUMENTARY_SECTIONS: DocumentarySection[] = [
  ...
  },
  {
    ...
    markers: [
      ...
      { label: 'Plasma Ball GLSL', url: 'collections/aether-sync/dist/index.html#standalone-Oldschool Plasma' },
      { label: 'Binary Streams', url: 'collections/aether-sync/dist/index.html#standalone-Binary Stream' }
    ],
  },
  {
    ...
    icon: '◈',
    markers: [
      { label: 'Interactive Ripple', url: 'collections/liquid-shader-ui/dist/examples/ripple/index.html#standalone' },
      { label: 'Liquid Mercury Nav', url: 'collections/liquid-shader-ui/dist/examples/mercury/index.html#standalone' },
      { label: 'Rainy Pond Surface', url: 'collections/liquid-shader-ui/dist/examples/pond/index.html#standalone' },
      { label: 'Physics Feedback', url: 'collections/liquid-shader-ui/dist/examples/rain/index.html#standalone' }
    ],
  },
  {
    title: 'The Synthesis',
  ...
  },
  {
    ...
    icon: '◆',
    markers: [
      { label: 'Neural Ripple AI', url: 'collections/shader-vault/dist/index.html#standalone-1' },
      { label: 'Data Singularity', url: 'collections/shader-vault/dist/index.html#standalone-6' },
      { label: 'Predictive Clusters', url: 'collections/shader-vault/dist/index.html#standalone-11' },
      { label: 'Adaptive Shapes', url: 'collections/shader-vault/dist/index.html#standalone-7' }
    ],
  },
];
